...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var calc = __webpack_require__(/*! ./moduls/calc.js */ "./src/js/moduls/calc.js"),
...
function modal() {
  ...
  var tabShow_more = document.getElementsByClassName("description-btn");
  ...
  function XHR() {
    ...
    var promise = function promise() {
      return new _Promise(function (resolve, reject) {
        ...
        request.open("POST", 'server.php'); // request.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');       - Для формата Formdata
    ...
    promise().finally(clearInput).then(function () {
...
function slider() {
  ...
  function showSlide(n) {
    if (n > slids.length) numSlider = 1;else if (n < 1) numSlider = slids.length;
...
function timer() {
  var deadline = new Date(2019, 8, 15, 0);
